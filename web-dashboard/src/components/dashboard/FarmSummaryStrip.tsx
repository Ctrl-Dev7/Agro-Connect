  ...
  const items = [
    {
      href: '/dashboard',
      icon: <Sprout size={15} />,
      label: `${data.activeCrops} ${data.activeCrops === 1 ? t('cropActive', 'crop active') : t('cropsActive', 'crops active')}`,
    ...
    },
    {
      ...
      label: `${data.highAlerts} ${data.highAlerts === 1 ? t('alert', 'alert') : t('alerts', 'alerts')}`,
    ...
    },
    {
      ...
      label: `${data.tasksDue} ${data.tasksDue === 1 ? t('taskDueToday', 'task due today') : t('tasksDueToday', 'tasks due today')}`,
    ...
    },
    {
      ...
      label: `${data.openBids} ${data.openBids === 1 ? t('marketplaceBid', 'marketplace bid') : t('marketplaceBids', 'marketplace bids')}`,
